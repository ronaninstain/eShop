                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('categories.update', $category->id) }}">
                        ...
                        <p class="mb-6">
                            ...
                            <input id="slug" name="slug" type="text" class="border p-3 w-full" value="{{ $category->slug }}">
                        </p>

                        <p class="mb-6">
                            <label for="userID" class="w-full text-gray-600 text-sm uppercase">Buyer</label>
                            <input id="UserID" name="userID" type="number" class="border p-3 w-full" value="{{ $category->userID }}">
                        </p>
